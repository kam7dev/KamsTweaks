...
public class EntityClaimPage extends GuiLayer {
    ...
    public static class EditPage extends GuiLayer {
        ...
        public EditPage(Player who, Entity target) {
            ...
            dialog = Dialog.create(builder -> {
                ...
                var base = DialogBase.builder(KTStrings.getFor(KTStrings.CLAIM_EDIT_TITLE, Names.instance.getEName(target).color(NamedTextColor.GOLD)));
    ...
    public static class SettingsPage extends GuiLayer {
        ...
        public SettingsPage(Player who, Entity target) {
            ...
            if (claim == null) return;
            dialog = Dialog.create(builder -> {
                var base = DialogBase.builder(KTStrings.getFor(KTStrings.CLAIM_SETTINGS, Names.instance.getEName(target).color(NamedTextColor.GOLD)));
        ...
        void init() {
            dialog = Dialog.create(builder -> {
                var base = DialogBase.builder(switch(mode) {
                    case ENTITY -> KTStrings.getFor(KTStrings.PERMS_EDIT_ENTITY, Names.instance.getEName(entity), Names.instance.getEName(target).color(NamedTextColor.GOLD));
                    case OFFLINE_PLAYER -> KTStrings.getFor(KTStrings.PERMS_EDIT_ENTITY, Names.instance.getName(player), Names.instance.getEName(target).color(NamedTextColor.GOLD));
                    case DEFAULT -> KTStrings.getFor(KTStrings.PERMS_EDIT_DEFAULT, Names.instance.getEName(target).color(NamedTextColor.GOLD));
                    case ENTITY_DEFAULT -> KTStrings.getFor(KTStrings.PERMS_EDIT_ENTITY_DEFAULT, Names.instance.getEName(target).color(NamedTextColor.GOLD));
                });
